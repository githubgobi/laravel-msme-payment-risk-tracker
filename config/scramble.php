...
return [
    ...
    'info' => [
        ...
        'description' => 'MSME Payment Risk Tracker — Section 43B(h) compliance platform API.
Includes vendor classification (LLM-powered), knowledge base (RAG), invoice risk tracking, and payment management.',
    ],
    ...
    'middleware' => [
        'web',
        // Restrict docs to non-production environments (or authenticated super-admins in prod)
